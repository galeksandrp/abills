...
function placeMarker() {
  select(\"placemark_b\");
   ...
   if (PolyInfoWindow) {
      ...
      var contentString = \"<div id=\'MarkerInfoWindow\'><a href=index.cgi?index=$index&coordx=\" + coordx + \"&coordy=\" + coordy + \" > $_ADD_HOUSE </a><br><a href=index.cgi?index=$index&DCOORDX=\" + coordx + \"&DCOORDY=\" + coordy + \"&ZOOM=\" + zoom + \" > $_ADD_DISTRICT </a><br><a href=index.cgi?index=$index&coordlx=\" + coordx + \"&coordly=\" + coordy + \"> $_ADD_ROUTE </a><br><a href=index.cgi?index=$index&coordwx=\" + coordx + \"&coordwy=\" + coordy + \"> $_ADD_WIFI_ZONE </a><br><a href=index.cgi?index=$index&coordwellx=\" + coordx + \"&coordwelly=\" + coordy + \"> $_ADD_WELL </a></div>\";
  ...
  <tr style=\"vertical-align:top\">
    <td style=\"width:15em\"><table>
	 ...
	 onclick=\"stopEditing()\"/ ></td>
          <td><div id=\"placemark_b\" onclick=\"placeMarker()\"/ title=\"$_ADD_HOUSE\"></td>
          <td><div id=\"addroute\" onclick=\"location.href='index.cgi?index=$index&route=add' \" title=\"$_CREATE_EDIT_ROUTE\"/></td>
        </tr>
      </table>
      <p> </p>
