...
<tr><td>CALLING_STATION_ID</td><td><input type=text name=CALLING_STATION_ID value='%CALLING_STATION_ID%'></td></tr>
<tr><td>CALLED_STATION_ID</td><td><input type=text name=CALLED_STATION_ID value='%CALLED_STATION_ID%'></td></tr>
