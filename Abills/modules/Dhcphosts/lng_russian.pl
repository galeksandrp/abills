...
$_NETWORK='Сеть';
$_SUBNET='Подсеть';
$_EXPIRED='Завершённые';
$ERR_WRONG_NETWORK  = 'Неправильная сеть. Проверте IP адрес и маску сети';
$ERR_WRONG_RANGE='Неправельный диапазон IP адресов';

$_DENY_UNKNOWN_CLIENTS='Запретить неизвесных клиентов';
$_AUTHORITATIVE='Авторизированный сервер для даной зоны';