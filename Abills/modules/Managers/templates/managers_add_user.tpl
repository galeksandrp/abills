...
<b>$_PHONE</b>: <input type=text  name='3.PHONE' value=\"$FORM{'3.PHONE'}\"><br><br>
...
<b>$_PAYMENTS</b>:<input type=text  name='5.SUM' value=\"$FORM{'5.SUM'}\" style='height:30px; width:80px; font-color: red; font-size:20px;'><br /><br />
<b>$_COMMENTS</b>:<br/>
