...
<tr bgcolor='$_COLORS[1]'><td>$_DEPOSIT:</td><td align=right>%DEPOSIT%</td></tr>
<tr bgcolor='$_COLORS[1]'><td>$_CREDIT:</td><td align=right>%CREDIT%</td></tr>


<tr bgcolor='$_COLORS[1]'><td>$_NAME:</td><td>%NAME%</td></tr>
