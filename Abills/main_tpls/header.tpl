...
<table width='100%' border='0' cellpadding='0' cellspacing='0'>
  <tr><th align='left'>$_DATE: %DATE% %TIME% Admin: <a href='$SELF_URL?index=50'>$admin->{A_LOGIN}</a> / Online: <abbr title=\"%ONLINE_USERS%\"><a href='$SELF_URL?index=50' title='%ONLINE_USERS%'>Online: %ONLINE_COUNT%</a></abbr></th><td align=center>%SEL_DOMAINS%</td>  <td align='right' width=400>
