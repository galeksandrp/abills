...
<TABLE width=100% cellspacing=1 cellpadding=0 border=0>
<tr bgcolor=$_COLORS[1]><td>$_SESSION_ID:</td><td>%SESSION_ID%</td></tr>
<tr bgcolor=$_COLORS[1]><td>$_BEGIN:</td><td align=right>%START%</td></tr>
...
<tr bgcolor=$_COLORS[1]><td>$_COMPANY_ID:</td><td>%COMPANY_ID%</td></tr>
